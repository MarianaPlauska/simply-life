...
/**
 * Layout das abas — build web. Arquivo à parte (Metro resolve `.web.tsx` só
 * no browser) só para trocar a sidebar por uma versão própria da web; o
 * app nativo continua usando `_layout.tsx` e `DesktopSidebar` sem alteração.
 */
