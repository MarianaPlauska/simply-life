...
export const AXEL_KANBAN_WORKSPACE =
  'flex-1 min-h-[360px] max-h-[min(680px,calc(100vh-260px))] h-[min(680px,calc(100vh-260px))] overflow-hidden flex flex-col lg:flex-row'
...
export const AXEL_KANBAN_CARD =
  'bg-card border border-line rounded-sl transition-[border-color] duration-150'
