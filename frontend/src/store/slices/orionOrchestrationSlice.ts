...
const VELOCITY_KEY = 'orion-velocity-samples-v1'
const LOG_MAX = 24
...
export interface OrionOrchestrationSlice
{
...
export const createOrionOrchestrationSlice: StateCreator<
...
> = (set, get) => ({
  ...
  {
    const store = get() as OrionOrchestrationSlice & {
