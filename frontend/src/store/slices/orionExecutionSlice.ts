...
const ESTIMATES_KEY = 'orion-task-estimates-v1'
const ELAPSED_KEY = 'orion-task-elapsed-v1'
...
export interface OrionExecutionState
{
  taskId: number
...
export interface OrionExecutionSlice
{
  execution: OrionExecutionState | null
...
type ExecutionStore = OrionExecutionSlice & {
...
export const createOrionExecutionSlice: StateCreator<
  ExecutionStore,
  [],
  [],
  OrionExecutionSlice
