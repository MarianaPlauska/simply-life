...
export interface OrionStreakSlice
{
  streakCount: number
...
type StreakStore = OrionStreakSlice & Pick<GamificacaoSlice, 'userStats' | 'spendXp'>

export const createOrionStreakSlice: StateCreator<
  StreakStore,
  [],
  [],
  OrionStreakSlice
