  ...
  return (
    <div className="flex flex-col h-full min-h-[280px]">
      <div className="flex items-baseline justify-between mb-2">
        <span className={ORION_DISPLAY_STAT}>{last}g</span>
        <span className={`font-mono text-[11px] ${ORION_TEXT_SECONDARY}`}>meta {meta}g</span>
      </div>
      ...
      <div className="flex-1 min-h-[220px]">
        <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
          <AreaChart data={rows} margin={{ top: 8, right: 4, left: -16, bottom: 0 }}>
            <defs>
              <linearGradient id="orionProteinFill" x1="0" y1="0" x2="0" y2="1">
