  ...
  return (
    <section className="sl-panel p-4 sm:p-5 space-y-4" aria-label="Painel de análise">
      <div>
        ...
        <h2 className={`font-display text-xl mt-1 ${AXEL_TEXT_PRIMARY}`}>Resumo do dia</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        <div className="rounded-sl border border-line bg-chrome/40 px-3 py-2">
          <p className="font-mono text-[9px] uppercase text-ink-muted flex items-center gap-1">
            <HeartPulse size={10} className="text-accent" />
            Ritual
          </p>
          <p className="font-display text-lg tabular-nums text-ink">{ritual.percent}%</p>
        ...
        <div className="rounded-sl border border-line bg-chrome/40 px-3 py-2">
          ...
          <p className="font-display text-lg tabular-nums text-ink">{streakCount}</p>
        ...
        <div className="rounded-sl border border-line bg-chrome/40 px-3 py-2">
          ...
          <p className="font-display text-lg tabular-nums text-ink">{waterPct}%</p>
        ...
        <div className="rounded-sl border border-line bg-chrome/40 px-3 py-2">
          ...
          <p className="font-display text-lg tabular-nums text-ink">{tarefasHoje.concluidas}</p>
