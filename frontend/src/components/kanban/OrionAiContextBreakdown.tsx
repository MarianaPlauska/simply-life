...
import { OrionRelevanceScoreInfo } from './OrionRelevanceScoreInfo'
import type { TarefaUnificada } from '../../types'

// Motor de Relevância — score + transparência (influência / semântica / prazo)

interface OrionAiContextBreakdownProps
{
...
export function OrionAiContextBreakdown({
  tarefa,
  allTasks,
  isCreatingNew = false,
}: OrionAiContextBreakdownProps)
{
