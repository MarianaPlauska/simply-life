...
interface AxelAbsoluteFocusOverlayProps
{
...
export function AxelAbsoluteFocusOverlay({
  horizonOverrides,
}: AxelAbsoluteFocusOverlayProps)
{
  ...
  async function handleComplete()
  {
    ...
    stopExecution()
    setBreathing(false)
    await axelCompleteTask({ ...live, subtarefas: subs })
